...
CREATE TABLE PRO_CLIENTES(
  ...
  CLI_CORREO VARCHAR2(80 ) NOT NULL,
...
CREATE TABLE PRO_PELICULAS(
  ...
  PEL_SYNOPSIS VARCHAR2(255 ),
  PEL_LINK VARCHAR2(255 ) NOT NULL,
...
;
COMMENT ON COLUMN PRO_SALAS.SAL_ESTADO IS 'ESTADO DE LA SALA (A:ACTIVA; I:INACTIVA)'
;
...
CREATE TABLE PRO_ASIENTOS(
  ...
  ASI_NOMBRE VARCHAR2(10 ) NOT NULL,
  ASI_CANTIDAD NUMBER NOT NULL,
  ASI_LISTA VARCHAR2 (155 ),
...
;
COMMENT ON COLUMN PRO_ASIENTOS.ASI_NOMBRE IS 'NOMBRE ASIENTOS (NOMBRE DE IMAGEN)'
;
COMMENT ON COLUMN PRO_ASIENTOS.ASI_LISTA IS 'LISTA DE LOS ASIENTOS CREADOS'
;
...
CREATE TABLE PRO_TANDAS(
  ...
  TAN_HORAINICIO VARCHAR2(8 ) NOT NULL,
  TAN_HORAFINAL VARCHAR2(8 ) NOT NULL,
