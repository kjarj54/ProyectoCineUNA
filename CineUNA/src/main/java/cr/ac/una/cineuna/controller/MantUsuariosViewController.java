...
public class MantUsuariosViewController extends Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Long id = (Long) AppContext.getInstance().get("EditarUsuario");
    ...
    public void bindClientes(Boolean nuevo) {
        ...
        chkActivo.selectedProperty().bindBidirectional(proClientesDto.cliEstado);
        chkAdmin.selectedProperty().bindBidirectional(proClientesDto.cliAdmin);
    ...
    public void unbindClientes() {
        ...
        chkActivo.selectedProperty().unbindBidirectional(proClientesDto.cliEstado);
        chkAdmin.selectedProperty().unbindBidirectional(proClientesDto.cliAdmin);
