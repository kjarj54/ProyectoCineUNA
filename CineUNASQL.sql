...
CREATE INDEX PRO_TANDASASIENTOS ON PRO_ASIENTOS (tan_id)
;
...
ALTER TABLE PRO_ASIENTOS ADD CONSTRAINT PRO_TANDASASIENTOS FOREIGN KEY (tan_id) REFERENCES PRO_TANDAS (tan_id)
;
