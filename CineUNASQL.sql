...
CREATE OR REPLACE TRIGGER ts_PRO_CLIENTES_PRO_CLIENTES_SEQ01 BEFORE INSERT
ON PRO_CLIENTES FOR EACH ROW
BEGIN
  :new.cli_id := PRO_CLIENTES_SEQ01.nextval;
END;
;
CREATE OR REPLACE TRIGGER tsu_PRO_CLIENTES_PRO_CLIENTES_SEQ01 AFTER UPDATE OF cli_id
ON PRO_CLIENTES FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER ts_PRO_PELICULAS_PRO_PELICULAS_SEQ01 BEFORE INSERT
ON PRO_PELICULAS FOR EACH ROW
BEGIN
  :new.pel_id := PRO_PELICULAS_SEQ01.nextval;
END;
;
CREATE OR REPLACE TRIGGER tsu_PRO_PELICULAS_PRO_PELICULAS_SEQ01 AFTER UPDATE OF pel_id
ON PRO_PELICULAS FOR EACH ROW
BEGIN
