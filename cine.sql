...
CREATE UNIQUE INDEX "PRO_CLIENTESALAS_FK01" ON "cineuna"."PRO_SALAS" ("reg_id")
;
...
CREATE UNIQUE INDEX "PRO_ASIENTOS_UNQ01" ON "cineuna"."PRO_ASIENTOS" ("sal_id")
;
...
CREATE UNIQUE INDEX "PRO_RESERVACION_UNQ01" ON "cineuna"."PRO_RESERVACION" ("reg_id")
;
...
;
COMMENT ON COLUMN "cineuna"."PRO_RESERVACION"."res_hora" IS 'fecha'
;
...
CREATE UNIQUE INDEX "PRO_TANDAS_UNQ01" ON "cineuna"."PRO_TANDAS" ("pel_id")
;
...
ALTER TABLE "cineuna"."PRO_COMIDAS" ADD CONSTRAINT "PK_PRO_COMIDAS" PRIMARY KEY ("com_id")
;
...
ALTER TABLE "cineuna"."PRO_RESERVACION" ADD CONSTRAINT "PRO_CLIENTESRESERVACION_FK01" FOREIGN KEY ("reg_id") REFERENCES "cineuna"."PRO_CLIENTES" ("cli_id")
;


ALTER TABLE "cineuna"."PRO_SALAS" ADD CONSTRAINT "PRO_CLIENTESALAS_FK01" FOREIGN KEY ("reg_id") REFERENCES "cineuna"."PRO_CLIENTES" ("cli_id")
;
...
ALTER TABLE "cineuna"."PRO_ASIENTOS" ADD CONSTRAINT "PRO_SALASASIENTOS" FOREIGN KEY ("sal_id") REFERENCES "cineuna"."PRO_SALAS" ("sal_id")
;
